...
Luckily, you can help them answer this question with data visualizations!

-   Make histograms of the prices of houses in Duke Forest based on whether they have a garage or not.
...
-   Choose an appropriate binwidth and decide whether a legend is needed. If it is not needed, turn it off.
-   Include informative title and axis labels.
-   Finally, include a brief (2-3 sentence) narrative comparing the distributions of prices of Duke Forest houses that do and do not have garages. Your narrative should touch on whether having a garage "makes a difference" in terms of the price of the house.
...
It's expected that within any given market, larger houses will be priced higher. It's also expected that the age of the house will have an effect on the price. However in some markets new houses might be more expensive while in others new construction might mean "no character" and hence be less expensive. So your family friends ask: "In Duke Forest, do houses that are bigger and more expensive tend to be newer than those that are smaller and cheaper?"
...
-   Discuss each of the following claims (1-2 sentences per claim). Your discussion should touch on specific things you observe in your plot as evidence for or against the claims.
    ...
    -   Claim 3: Bigger and more expensive houses tend to be newer than smaller and cheaper ones.
